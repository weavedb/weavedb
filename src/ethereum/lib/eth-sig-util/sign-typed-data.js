import { isNullish, numberToBuffer, recoverPublicKey } from "./utils"
import { keccak256 } from "../ethereum-cryptography/keccak"
import { arrToBufArr, publicToAddress, bufferToHex } from "../ethereumjs/util"
import { isHexString } from "../ethjs-util"
import { rawEncode } from "./ethereumjs-abi-utils"
...
export function recoverTypedSignature({ data, signature, version }) {
  if (isNullish(data)) {
