# Decentralized Log-Structured Engine

![modular.excalidraw](/images/architecture.png)

WeaveDB is a decentralized, log-structured storage engine built on Arweave for permanent storage and the AO Core Protocol for verifiable compute.
