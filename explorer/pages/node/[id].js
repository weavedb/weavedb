    ...
    <>
      ...
      >
        <Box w="100%" maxW="1400px">
          ...
          <Link href="/node/alpha/db/offchain">
            <Box
              w="100%"
              bg="white"
              py={2}
            ...
            >
              <Flex>
                ...
                <Box mx={4} py={2} sx={{ borderRight: "1px solid #ddd" }}></Box>
                <Box flex={1}>
                  <Box sx={{ color: "#999" }}>L2 Contract TxID</Box>
                  <Box sx={{ fontSize: "14px" }}>
                    <Box>None</Box>
                  </Box>
                </Box>
                ...
                <Box flex={1}>
                  ...
                  <Box sx={{ fontSize: "14px" }}>jots-alpha.weavedb.dev</Box>
                </Box>
              </Flex>
            </Box>
          </Link>
          <Link href="/node/alpha/db/nostr">
            <Box
              w="100%"
              bg="white"
              py={2}
            ...
            >
              <Flex>
                ...
                <Box flex={1}>
                  <Box sx={{ color: "#999" }}>DApp URL</Box>
                  <Box sx={{ fontSize: "14px" }}>jots-nostr.vercel.app</Box>
                </Box>
              </Flex>
            </Box>
          </Link>
