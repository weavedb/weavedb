...
const utils = require("./ffutils.js")
const { getThreadRng } = require("./random.js")
const buildBatchConvert = require("./engine_batchconvert.js")
const BigBuffer = require("./bigbuffer.js")
...
class WasmField1 {
  constructor(tm, prefix, n8, p) {
    ...
    this.mask = Scalar.sub(
      Scalar.shiftLeft(Scalar.one, this.bitLength),
      Scalar.one
    )
