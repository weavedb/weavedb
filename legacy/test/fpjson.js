  ...
  const cases = [
    ...
    },
    {
      ...
      tests: [
        ...
        [
          ["remove", 0, 2, [8, 4, 8, 3, 6]],
          [8, 3, 6],
        ],
        [
          ["without", [4, 5, 0], [5, 3, 6, 6, 3, 2, 5, 6, 4]],
          [3, 6, 6, 3, 2, 6],
        ],
        [["take", 1, [3, 5, 3, 1, 2]], [3]],
        [
          ["takeLast", 4, [0, 8, 5, 5, 0]],
          [8, 5, 5, 0],
        ],
        [
          ["drop", 1, [6, 7, 0, 5, 4]],
        ...
        [
          ["dropLast", 3, [1, 6, 3, 0, 5]],
          [1, 6],
        ],
        [
          ["slice", 0, 7, [6, 7, 0, 0, 3, 3, 2, 8, 6]],
          [6, 7, 0, 0, 3, 3, 2],
        ],
      ],
    },
    {
      ...
      tests: [
        ...
        [
          ["symmetricDifference", [7, 0, 3], [4, 1, 7]],
          [0, 3, 4, 1],
        ],
        [
          ["unionWith", ["eqBy", ["negate"]], [-2, -3, 2], [1, 1, -5]],
          [-2, -3, 2, 1, -5],
        ],
        [
          ["differenceWith", ["eqBy", ["inc"]], [-3, 2, -4], [1, -3, -2]],
          [2, -4],
        ],
        [
          [
    ...
    },
    {
      ...
      tests: [
        ...
        [
          ["uniqBy", ["inc"], [2, 0, 2, 2, -5, -5, -1, -2, -5]],
          [2, 0, -5, -1, -2],
        ],
        [
          ["uniqWith", ["eqBy", ["negate"]], [3, -4, -5, 2, -3, -1, 1, -3, -1]],
          [3, -4, -5, 2, -3, -1, 1],
        ],
        [
          ["dropWhile", ["gte", 0], [0, -3, 1, -5, 3]],
          [1, -5, 3],
        ],
        [
          ["dropLastWhile", ["lte", -1], [0, 2, -2, 0, 1]],
          [0, 2, -2],
        ],
        [
          ["dropRepeatsWith", ["gt", 3], [-5, 3, 0, 2, -4, -1, 3, -1, -5]],
          [-5],
        ],
        [["takeWhile", ["lt", -1], [1, -3, -3, 3, 2]], [1]],
        [["takeLastWhile", ["gte", -4], [1, -3, 3, 0, -5]], [-5]],
        [
          ["sort", ["subtract"], [6, 1, 1, 3, 4, 8, 2, 2, 0]],
          [0, 1, 1, 2, 2, 3, 4, 6, 8],
        ],
        [
          ["sortBy", ["dec"], [-4, -2, -1, 0, 0]],
          [-4, -2, -1, 0, 0],
        ],
        [
          [
    ...
    },
    {
      ...
      tests: [
        ...
        [
          ["collectBy", ["equals", -1], [-4, 2, 3, -1, 0]],
          [[-4, 2, 3, 0], [-1]],
        ],
        [
          ["groupWith", ["gte", -5], [0, 7, 7, 3, 4, 4, 3, 2, 3]],
          [[0], [7], [7], [3], [4], [4], [3], [2], [3]],
        ],
        [
          ["partition", ["lt", -1], [-3, -3, -1, -4, 1]],
          [[1], [-3, -3, -1, -4]],
        ],
        [
          ["splitAt", 1, [3, 1, 6, 5, 2, 4, 8, 2, 6]],
          [[3], [1, 6, 5, 2, 4, 8, 2, 6]],
        ],
        [
          ["splitEvery", 3, [0, 1, 1, 6, 2, 0, 2, 3, 1]],
          [
            [0, 1, 1],
            [6, 2, 0],
            [2, 3, 1],
        ...
        [
          ["splitWhen", ["equals", -3], [-4, -4, 3, -3, 2, -3, 2, 1, 1]],
          [
            [-4, -4, 3],
            [-3, 2, -3, 2, 1, 1],
          ],
        ...
        [
          ["splitWhenever", ["equals", -5], [1, 1, -5, 1, -2, -1, -2, -4, -1]],
          [
            [1, 1],
            [1, -2, -1, -2, -4, -1],
          ],
    ...
    },
    {
      ...
      tests: [
        ...
        [
          [
            "mapAccumRight",
            ["compose", ["repeat", ["__"], 2], ["subtract", -3]],
            6,
            [4, 7, 4],
          ],
          [-9, [-9, 6, -9]],
    ...
    },
    {
      ...
      tests: [
        ...
        [
          ["evolve", { a: ["inc"] }, { C: 2, d: 3, E: 4 }],
          { C: 2, d: 3, E: 4 },
        ],
        [["invert", { d: 0, C: 8, A: 4 }], { 0: ["d"], 4: ["A"], 8: ["C"] }],
        [["invertObj", { e: 6, a: 0, b: 1 }], { 0: "a", 1: "b", 6: "e" }],
        [
          ["mapObjIndexed", ["inc"], { B: 0, d: 4, b: 8 }],
          { B: 1, d: 5, b: 9 },
        ],
        [
          ["unwind", "c", { A: [6, 2, 8], d: [7, 8, 6], C: [0, 0, 7] }],
          [{ A: [6, 2, 8], d: [7, 8, 6], C: [0, 0, 7] }],
        ],
      ],
    },
    {
      ...
      tests: [
        ...
        [
          [
            ...
            { B: { E: 1, B: 5 }, b: { a: 5, e: 8, C: 8 } },
          ],
          {
            b: { c: 3, a: 10, e: 8, C: 8 },
            B: { b: 6, D: 3, c: 6, E: 1, B: 5 },
            E: { D: 6, d: 3, a: 8 },
          },
        ],
        [
          ["mergeLeft", { A: 3, c: 4, a: 3 }, { B: 7, d: 4 }],
          { B: 7, d: 4, A: 3, c: 4, a: 3 },
        ],
        [
          ["mergeRight", { D: 6, e: 1, c: 1 }, { B: 2, d: 6, b: 1 }],
          { D: 6, e: 1, c: 1, B: 2, d: 6, b: 1 },
        ],
        [
          [
            "mergeWith",
      ...
      tests: [
        ...
        [
          ...
          ],
          {
            3: { c: 3, D: 3, A: 7 },
            8: { D: 8, e: 2 },
            undefined: { C: 0, e: 2, d: 6 },
          },
        ],
        [["countBy", ["dec"], [0, 6, 7]], { 5: 1, 6: 1, "-1": 1 }],
        [
          ["reduceBy", ["subtract", -3], 2, ["lte", -2], [0, 3, 1]],
          { true: -5 },
        ],
        [
          [["applySpec", { e: ["negate"], A: ["negate"], E: ["negate"] }], 6],
          { e: -6, A: -6, E: -6 },
        ],
      ],
    },
