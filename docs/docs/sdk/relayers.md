...
- `ipfsId` : an IPFS CID where the multisigs have to come from. The multisig relayers should be [Lit Protocol](https://litprotocol.com/) PKPs for verifiability.
